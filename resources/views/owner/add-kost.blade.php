                            ...
                            <form action="/owner/add-kost" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 no-padding">
                                        ...
                                        <input type="text" placeholder="Contoh : 4 x 5 M" id="form-panjang" name="ukuran_kamar">
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-12 no-padding">
                                        <label for="form-kamar">Kamar Kost</label>
                                        <input type="number" placeholder="Jumlah Kamar Kost ..." id="form-harga" name="jumlah_kamar" min="1">
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-12 no-padding">
                                        <label for="form-penghuni">Penghuni Sekarang</label>
                                        <input type="number" placeholder="Jumlah Penghuni Sekarang ..." id="form-harga" name="jumlah_penghuni">
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-12 no-padding">
                                        <label for="form-harga">Harga Kos Bulanan</label>
                                        <input type="number" placeholder="Harga Kos Bulanan ..." id="form-harga" name="price" min="1000">
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-12 no-padding">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 no-padding">
                                        ...
                                        <input type="text" placeholder="Contoh : Tanggal 5 " id="form-harga" name="jatuh_tempo">
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 no-padding">
                                        ...
                                        <input type="text" placeholder="Kabupaten ..." id="form-kecamatan" name="kabupaten">
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-12 no-padding">
